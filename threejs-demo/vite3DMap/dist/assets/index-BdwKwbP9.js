...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:0,depthTest:!1,depthWrite:!1})}function Ns(e,t,n){let r=new Float32Array(ys),i=new q(0,1,0);return new Za({name:`SphericalGaussianBlur`,defines:{n:ys,CUBEUV_TEXEL_WIDTH:1/t,CUBEUV_TEXEL_HEIGHT:1/n,CUBEUV_MAX_MIP:`${e}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:r},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:i}},vertexShader:Is(),fragmentShader:`
	...
	`}var Ls=class extends Gt{constructor(e=1,t={}){super(e,e,t),this.isWebGLCubeRenderTarget=!0;let n={width:e,height:e,depth:1},r=[n,n,n,n,n,n];this.texture=new bi(r),this._setTextureOptions(t),this.texture.isRenderTargetTexture=!0}fromEquirectangularTexture(e,t){this.texture.type=t.type,this.texture.colorSpace=t.colorSpace,this.texture.generateMipmaps=t.generateMipmaps,this.texture.minFilter=t.minFilter,this.texture.magFilter=t.magFilter;let n={uniforms:{tEquirect:{value:null}},vertexShader:`
	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};Bf.BlurDirectionX=new K(1,0),Bf.BlurDirectionY=new K(0,1);var Vf={name:`OutputShader`,uniforms:{tDiffuse:{value:null},toneMappingExposure:{value:1}},vertexShader:`
		precision highp float;
		...
		}`},Hf=class extends Af{constructor(){super(),this.isOutputPass=!0,this.uniforms=Ja.clone(Vf.uniforms),this.material=new Qa({name:Vf.name,uniforms:this.uniforms,vertexShader:Vf.vertexShader,fragmentShader:Vf.fragmentShader}),this._fsQuad=new Nf(this.material),this._outputColorSpace=null,this._toneMapping=null}render(e,t,n){this.uniforms.tDiffuse.value=n.texture,this.uniforms.toneMappingExposure.value=e.toneMappingExposure,(this._outputColorSpace!==e.outputColorSpace||this._toneMapping!==e.toneMapping)&&(this._outputColorSpace=e.outputColorSpace,this._toneMapping=e.toneMapping,this.material.defines={},Y.getTransfer(this._outputColorSpace)===`srgb`&&(this.material.defines.SRGB_TRANSFER=``),this._toneMapping===1?this.material.defines.LINEAR_TONE_MAPPING=``:this._toneMapping===2?this.material.defines.REINHARD_TONE_MAPPING=``:this._toneMapping===3?this.material.defines.CINEON_TONE_MAPPING=``:this._toneMapping===4?this.material.defines.ACES_FILMIC_TONE_MAPPING=``:this._toneMapping===6?this.material.defines.AGX_TONE_MAPPING=``:this._toneMapping===7?this.material.defines.NEUTRAL_TONE_MAPPING=``:this._toneMapping===5&&(this.material.defines.CUSTOM_TONE_MAPPING=``),this.material.needsUpdate=!0),this.renderToScreen===!0?(e.setRenderTarget(null),this._fsQuad.render(e)):(e.setRenderTarget(t),this.clear&&e.clear(e.autoClearColor,e.autoClearDepth,e.autoClearStencil),this._fsQuad.render(e))}dispose(){this.material.dispose(),this._fsQuad.dispose()}},Uf,Wf,Gf,Kf,qf,Jf,Yf;function Xf(){Jf=document.getElementById(`three-container`),Jf&&(Qf(),ip().then(()=>ap()).catch(e=>{console.error(e),ap()}),window.addEventListener(`resize`,Zf))}function Zf(){if(!Jf||!Wf||!Gf)return;let e=Jf.clientWidth,t=Jf.clientHeight;e===0||t===0||(Wf.aspect=e/t,Wf.updateProjectionMatrix(),Gf.setSize(e,t),Kf&&(Kf.setPixelRatio(Gf.getPixelRatio()),Kf.setSize(e,t)))}function Qf(){let e=Jf.clientWidth||window.innerWidth,t=Jf.clientHeight||window.innerHeight;Uf=new jn,Uf.background=new X(198928),Uf.add(new Fo(9090303,.22));let n=new Po(15267071,.72);n.position.set(28,36,42),Uf.add(n);let r=new Po(4881663,.28);r.position.set(-24,-12,18),Uf.add(r);let i=new Po(51455,.18);i.position.set(0,40,-20),Uf.add(i),Wf=new jo(75,e/t,.1,1e3),Wf.up.set(0,1,0),Wf.position.set(0,-34,32),Wf.lookAt(0,0,0);let a=Math.min(window.devicePixelRatio,2);Gf=new xu({antialias:!0}),Gf.setPixelRatio(a),Gf.setSize(e,t),Gf.outputColorSpace=Ie,Gf.toneMapping=4,Gf.toneMappingExposure=.78,Jf.appendChild(Gf.domElement),Kf=new Lf(Gf),Kf.setPixelRatio(a),Kf.setSize(e,t),Kf.addPass(new Rf(Uf,Wf));let o=new Bf(new K(e,t),.55,.4,.22);Kf.addPass(o),Kf.addPass(new Hf),qf=new gf(Wf,Gf.domElement),qf.enableDamping=!0,qf.dampingFactor=.08,qf.minDistance=8,qf.maxDistance=200}function $f(e,t){if(e?.coordinates){if(e.type===`Polygon`)t(e.coordinates);else if(e.type===`MultiPolygon`)for(let n of e.coordinates)t(n)}}function ep(e){let t=0;for(let n=0;n<e.length;n++){let r=e[n],i=e[(n+1)%e.length];t+=r.x*i.y-i.x*r.y}return t*.5}function tp(e,t){let n=e.map(e=>t(e[0],e[1]));if(n.length<3)return null;let r=n;return r[0].distanceTo(r[r.length-1])<1e-8&&(r=r.slice(0,-1)),r.length<3?null:r}function np(e,t){let n=tp(e[0],t);if(!n)return null;ep(n)<0&&n.reverse();let r=new ta(n);for(let n=1;n<e.length;n++){let i=tp(e[n],t);i&&(ep(i)>0&&i.reverse(),r.holes.push(new ea(i)))}return r}function rp(e){Yf&&Uf.remove(Yf),Yf=new Cn,Yf.name=`debug-frame`;let t=e*.35;Yf.add(new ns(t));let n=new ts(e,Math.max(10,Math.round(e/2)),2048096,991800);n.rotation.x=-Math.PI/2,Yf.add(n),Uf.add(Yf)}async function ip(){let e=await fetch(`/100000_full.json`);if(!e.ok)throw Error(`加载地图数据失败: ${e.status}`);let t=await e.json(),n=rf().fitExtent([[0,0],[42,42]],t);function r(e,t){let r=n([e,t]);if(!r)return new K(0,0);let[i,a]=r;return new K(i-21,-(a-21))}let i=42*.022,a={depth:i,bevelEnabled:!1},o=new $a({color:1732495,emissive:670290,emissiveIntensity:.55,metalness:.18,roughness:.36,side:2,flatShading:!1}),s=new oi({color:12123135,transparent:!0,opacity:.95,polygonOffset:!0,polygonOffsetFactor:-4,polygonOffsetUnits:-4}),c=new Cn;c.name=`china-map`;for(let e of t.features){let t=e.geometry;t&&$f(t,e=>{let t=np(e,r);if(t)try{let n=new Jr(new za(t,a),o);n.renderOrder=0,i+.008;for(let t=0;t<e.length;t++){let i=tp(e[t],r);if(!i)continue;let a=i.map(e=>new q(e.x,e.y,.9319999999999999)),o=new yi(new Tr().setFromPoints(a),s);o.renderOrder=2,n.add(o)}c.add(n)}catch{}})}c.updateMatrixWorld(!0);let l=new Kn().setFromObject(c),u=new q;l.getCenter(u),c.position.sub(u),rp(42),Uf.add(c)}function ap(){requestAnimationFrame(ap),qf.update(),Kf.render()}Xf();